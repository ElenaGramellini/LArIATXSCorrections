...
muonInBeam60A  = 0.075*changeMu  # 7.5% muons
elecInBeam60A  = 0.181*changeE   # 18.1% electrons
...
#outFileName = "BkgSub_"+str(changeMu)+"muons_"+str(changeE)+"electrons_60A.root"
