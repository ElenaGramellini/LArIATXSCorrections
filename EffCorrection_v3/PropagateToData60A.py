...
outFileName = "Eff_Correction_60A_WithBoundaries.root"

effFileName = "Eff_Correction_60A.root"
effFile     = TFile.Open(effFileName)
effC_XS_60A_45   = effFile.Get("move_XS_45_60A")
effC_XS_60A_All  = effFile.Get("move_XS_All_60A")

dataFileName  = "../BkgSub_v3/BkgSubWithBuoundaries_60A.root"
dataFile      = TFile.Open(dataFileName)
dataC_XS_60A  = dataFile.Get("XS_BkgSub60A")


XS_Eff_45 = dataC_XS_60A.Clone("XS_Eff_60A_45")
XS_Eff_45.Multiply(effC_XS_60A_45)

XS_Eff_All = dataC_XS_60A.Clone("XS_Eff_60A_All")
XS_Eff_All.Multiply(effC_XS_60A_All)
