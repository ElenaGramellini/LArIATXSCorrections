...
MCName = "../../MC_v3/MC_Staggered_Data100A.root"
...
legendInt.AddEntry(pionMC_Int,"MC 100A predicted pions");
legendInt.AddEntry(secoMC_Int,"MC 100A predicted muons");
legendInt.AddEntry(elecMC_Int,"MC 100A predicted electrons");
legendInt.Draw("same")
p1.Update()
p1.SaveAs(noRootFileName+"_MCData_Int_StatSyst.png")
...
legendInc.AddEntry(pionMC_Int,"MC 100A predicted pions");
legendInc.AddEntry(secoMC_Int,"MC 100A predicted muons");
legendInc.AddEntry(elecMC_Int,"MC 100A predicted electrons");

legendInc.Draw("same")
p2.Update()
p2.SaveAs(noRootFileName+"_MCData_Inc_StatSyst.png")
...
legendXS.Draw("same")
cXS.Update()
cXS.SaveAs(noRootFileName+"_MCData_XS_StatSyst.png")
